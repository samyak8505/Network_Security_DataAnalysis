...
from networksecurity.entity.config_entity import DatValidationConfig
...
class DataValidation:
    def __init__(self,data_ingestion_artifact:DataIngestionArtifact,data_validation_config:DatValidationConfig):
        try:
